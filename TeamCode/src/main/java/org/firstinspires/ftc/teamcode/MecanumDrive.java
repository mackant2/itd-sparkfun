...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0006721440882864844; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 10830.298104058482;

        // feedforward parameters (in tick units)
        public double kS = 1.6172393766026643;
        public double kV =  0.00014583206753416588;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = parsedHardwareMap.frontLeft;
        leftBack = parsedHardwareMap.backLeft;
        rightBack = parsedHardwareMap.backRight;
        rightFront = parsedHardwareMap.frontRight;
